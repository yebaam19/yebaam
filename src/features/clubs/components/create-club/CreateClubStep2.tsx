...
export const CreateClubStep2: FC<CreateClubStep2Props> = ({ data, onUpdate, onNext, onBack }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h4 className="mb-2 text-lg font-medium text-gray-900 dark:text-white">Configuración del club</h4>
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Define la privacidad y detalles adicionales de tu club
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
          {privacy === 'PUBLIC'
            ? 'Los miembros pueden unirse libremente'
            : 'Los administradores deben aprobar las solicitudes'}
        </p>
      </div>
      ...
      <div>
        <label htmlFor="club-subcategory" className="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
          Subcategoría <span className="text-xs text-gray-400">(opcional)</span>
        </label>
        <input
          id="club-subcategory"
          type="text"
          ...
          placeholder="Ej: Ciencia Ficción, Fútbol, Fotografía Digital..."
          maxLength={50}
          className="block w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 placeholder-gray-400 focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-white"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          placeholder="Ej: Ciudad, País o 'Online'"
          maxLength={100}
          className="block w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 placeholder-gray-400 focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-white"
        />
      </div>
      ...
      <div>
        <label htmlFor="club-website" className="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
          Sitio web <span className="text-xs text-gray-400">(opcional)</span>
        </label>
        <input
          id="club-website"
          type="url"
