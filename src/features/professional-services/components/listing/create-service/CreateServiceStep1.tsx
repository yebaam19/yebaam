    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">
          Dale un nombre y descripción a tu servicio profesional
        </p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          placeholder="Ej: Consultoría Legal Express"
          maxLength={100}
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">{description.length}/1000 caracteres</p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          placeholder="Ej: Calle 100 #15-20, Oficina 501"
          className="block w-full rounded-lg border border-neutral-300 bg-white px-4 py-3 text-neutral-900 placeholder-neutral-400 focus:border-transparent focus:ring-2 focus:ring-primary-500 focus:outline-none dark:border-neutral-600 dark:bg-neutral-700 dark:text-white"
        />
      </div>
