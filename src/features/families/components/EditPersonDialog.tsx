  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-lg rounded-2xl border border-zinc-200 bg-white p-5 shadow-xl dark:border-zinc-800 dark:bg-zinc-900">
        <h3 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">Editar persona</h3>
        <form onSubmit={handleSubmit} className="mt-4 space-y-3">
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-zinc-700 dark:text-zinc-300">Género</label>
            <select
              value={gender}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="mb-1 block text-xs font-medium text-zinc-700 dark:text-zinc-300">Nacimiento</label>
              <input
                type="date"
                value={birthDate}
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-zinc-700 dark:text-zinc-300">Lugar nacimiento</label>
              <input
                type="text"
                value={birthPlace}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="mb-1 block text-xs font-medium text-zinc-700 dark:text-zinc-300">Defunción</label>
              <input
                type="date"
                value={deathDate}
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-zinc-700 dark:text-zinc-300">Lugar defunción</label>
              <input
                type="text"
                value={deathPlace}
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-zinc-700 dark:text-zinc-300">Biografía</label>
            <textarea
              value={bio}
