    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        ...
        <input
          ...
          maxLength={80}
          placeholder="Ej. Familia Velandia"
      ...
      <div>
        ...
        />
        <p className="mt-1 text-xs text-zinc-500">Se sube a Cloudflare Images.</p>
      </div>
      ...
      <div className="flex items-center justify-between gap-3">
        <p className="text-xs text-zinc-500">
          Tu familia será privada por invitación. Solo los miembros podrán ver el contenido.
        </p>
        <button
          type="submit"
          disabled={busy}
