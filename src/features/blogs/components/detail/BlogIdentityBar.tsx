        ...
        <div className="mb-2 flex items-center gap-2 overflow-x-auto rounded-md border border-dashed border-neutral-200 bg-white/60 px-2 py-1.5 sm:px-3 dark:border-neutral-700 dark:bg-neutral-800/60">
          {Array.from({ length: 6 }).map((_, i) => (
            <span
              ...
              className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-neutral-100 text-neutral-300 sm:h-7 sm:w-7 dark:bg-neutral-700 dark:text-neutral-500"
            >
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              {blog.isVerified && <CheckBadgeIcon className="h-5 w-5 shrink-0 text-primary-500 sm:h-6 sm:w-6" />}
