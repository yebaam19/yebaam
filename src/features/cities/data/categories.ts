  ...
  const allItems = [
    {
      ...
      href: `/feed/cities/${citySlug}/public-chat`,
      isComingSoon: true,
      enabled: true,
    },
    {
      ...
      label: 'Promociones',
      icon: 'TagIcon',
      href: `/feed/cities/${citySlug}/promotions`,
      isComingSoon: true,
      enabled: true,
    },
    {
      ...
      label: 'Noticias',
      icon: 'NewspaperIcon',
      href: `/feed/cities/${citySlug}/news`,
      isComingSoon: true,
      enabled: true,
    },
    {
      ...
      label: 'Directorio',
      icon: 'BookOpenIcon',
      href: `/feed/cities/${citySlug}/directory`,
      isComingSoon: false,
      enabled: true,
    },
    {
      ...
      label: 'Clubs y blogs',
      icon: 'UserGroupIcon',
      href: `/feed/cities/${citySlug}/clubs`,
      isComingSoon: true,
      enabled: true,
    },
    {
      ...
      href: `/feed/cities/${citySlug}/forums`,
      isComingSoon: true,
      enabled: true,
    },
    {
      ...
      label: 'Clasificados',
      icon: 'MegaphoneIcon',
      href: `/feed/cities/${citySlug}/classifieds`,
      isComingSoon: true,
      enabled: true,
    },
    {
      ...
      label: 'Ayuda social',
      icon: 'HeartIcon',
      href: `/feed/cities/${citySlug}/social-help`,
      isComingSoon: true,
      enabled: true,
    },
    {
      ...
      label: 'Contacto',
      icon: 'EnvelopeIcon',
      href: `/feed/cities/${citySlug}/contact`,
      isComingSoon: true,
      enabled: true,
    },
  ];
