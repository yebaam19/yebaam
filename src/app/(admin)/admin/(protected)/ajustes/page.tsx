        ...
        <div className="flex min-w-0 flex-col gap-6">
          ...
          <section className="rounded-2xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <footer className="border-t border-neutral-200 bg-neutral-50/50 px-5 py-3 text-[11px] text-neutral-500 dark:border-neutral-800 dark:bg-neutral-900/40">
              {t('adminsFooter')} <code className="rounded bg-neutral-100 px-1 py-0.5 font-mono text-[10px] dark:bg-neutral-800">platform_admins</code>.
            </footer>
          </section>
        </div>
          ...
          <section className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="mt-4 flex flex-col gap-3">
              <ShortcutCard
                ...
                label={t('shortcutForos')}
                description={t('shortcutForosDesc')}
                icon={ChatBubbleLeftRightIcon}
              />
              <ShortcutCard
                href={'/admin/usuarios' as Route}
                label={t('shortcutUsuarios')}
                description={t('shortcutUsuariosDesc')}
                icon={UsersIcon}
              />
              <ShortcutCard
                href={'/admin' as Route}
                label={t('shortcutDashboard')}
                description={t('shortcutDashboardDesc')}
                icon={Cog6ToothIcon}
              />
            </div>
          </section>
