  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Familias</h1>
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
            Espacios privados por invitación: árbol genealógico, línea de tiempo, fotos, historias y documentos.
          </p>
        </div>
        <Link
        ...
        {families.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-zinc-300 bg-zinc-50 px-6 py-16 text-center dark:border-zinc-700 dark:bg-zinc-900/40">
            ...
            <p className="mt-1 max-w-md text-sm text-zinc-600 dark:text-zinc-400">
              Crea una para comenzar tu árbol genealógico, o pídele a un familiar que te invite a la suya.
            </p>
            <Link
              href="/feed/familias/nueva"
