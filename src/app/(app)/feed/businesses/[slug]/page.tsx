...
export default function BusinessProfilePage() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-neutral-600 dark:text-neutral-400">Cargando negocio...</p>
        </div>
      </div>
    )
  }
  ...
  if (error || !business) {
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center">
          <h2 className="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Negocio no encontrado</h2>
          <p className="text-gray-600 dark:text-gray-400">El negocio que buscas no existe o ha sido eliminado.</p>
        </div>
      </div>
    )
  }
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
          ...
          <div className="lg:col-span-3">
              ...
              <>
                ...
                {activeTab === 'acerca-de' && (
                  <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-neutral-800">
                    <h2 className="mb-4 text-2xl font-bold text-neutral-900 dark:text-white">Acerca de</h2>
            ...
            {sidebarSection === 'valoraciones' && (
              <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-neutral-800">
                <h2 className="mb-4 text-2xl font-bold text-neutral-900 dark:text-white">Valoraciones</h2>
            ...
            {sidebarSection === 'horarios' && (
              <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-neutral-800">
                <h2 className="mb-4 text-2xl font-bold text-neutral-900 dark:text-white">Horarios</h2>
                {business.hours && Object.keys(business.hours).length > 0 ? (
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-neutral-600 dark:text-neutral-400">
                            {hourData?.open || 'Cerrado'} - {hourData?.close || ''}
                          </span>
                        </div>
                      )
                    })}
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400">No hay horarios disponibles.</p>
                )}
              </div>
            )}
            ...
            {sidebarSection === 'contacto' && (
              <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-neutral-800">
                <h2 className="mb-4 text-2xl font-bold text-neutral-900 dark:text-white">Contacto</h2>
                <div className="space-y-4">
                  {business.phone && (
                    <div>
                      <h3 className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Teléfono</h3>
                  ...
                  {business.website && (
                    <div>
                      <h3 className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Sitio web</h3>
                      <a
                  ...
                  {business.address && (
                    <div>
                      <h3 className="text-sm font-medium text-neutral-500 dark:text-neutral-400">Dirección</h3>
