...
export default function ServiceProfileLoading() {
  return (
    <div className="mx-auto max-w-7xl px-4 pt-6">
      ...
      <div className="grid grid-cols-1 items-start gap-x-6 gap-y-6 py-6 lg:grid-cols-[9rem_13rem_minmax(0,1fr)] xl:grid-cols-[11rem_16rem_minmax(0,1fr)]">
        ...
        <div className="flex flex-row gap-3 lg:col-start-1 lg:row-start-2 lg:flex-col">
          {[1, 2, 3].map((i) => (
