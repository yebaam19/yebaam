...
/** Music archive shell. Mirrors `feed/layout.tsx` but stays public-accessible:
 *  anonymous visitors get the page without sidebars (público abierto), authed
 *  users get the same Sidebar + RightSidebar feed users see. */
